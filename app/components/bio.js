        ...
        return (
            <div>
                ...
                <div className="col-xs-10 col-sm-9 col-md-5 bio__text-container">
                    <h3>About Me</h3>
                    <p>My name's Matt. I'm a conscientious, user-focused developer with exceptional communication.
                        I've got skills in React, Angular, jQuery, CSS, SASS, PHP and Wordpress.</p>
